// $ANTLR 3.5.2 ../src/projet.g 2018-02-15 08:25:56
...
public class projetParser extends Parser {
	...
	public final void decproc() throws RecognitionException {
		try {
			...
			{
			match(input,47,FOLLOW_47_in_decproc444); 
		...
		try {
			...
			switch (alt21) {
				case 1 :
					// ../src/projet.g:83:9: ';'
					{
					match(input,17,FOLLOW_17_in_ptvg477); 
					}
					break;
				case 2 :
					// ../src/projet.g:85:3: 
	...
	public final void corps() throws RecognitionException {
		try {
			...
			{
			match(input,29,FOLLOW_29_in_corps495); 
			pushFollow(FOLLOW_instructions_in_corps497);
			instructions();
			state._fsp--;

			match(input,39,FOLLOW_39_in_corps499); 
			}
	...
	public final void parfixe() throws RecognitionException {
		try {
			...
			{
			match(input,40,FOLLOW_40_in_parfixe511); 
			match(input,9,FOLLOW_9_in_parfixe513); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,17,FOLLOW_17_in_parfixe519); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_pf546); 
	...
	public final void parmod() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_parmod566); 
			match(input,9,FOLLOW_9_in_parmod568); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,17,FOLLOW_17_in_parmod574); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_pm601); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,17,FOLLOW_17_in_instructions626); 
	...
	public final void inssi() throws RecognitionException {
		try {
			...
			{
			match(input,50,FOLLOW_50_in_inssi692); 
			pushFollow(FOLLOW_expression_in_inssi694);
			expression();
			state._fsp--;

			match(input,24,FOLLOW_24_in_inssi696); 
			...
			match(input,41,FOLLOW_41_in_inssi708); 
			}
	...
	public final void inscond() throws RecognitionException {
		try {
			...
			{
			match(input,27,FOLLOW_27_in_inscond722); 
			pushFollow(FOLLOW_expression_in_inscond725);
			expression();
			state._fsp--;

			match(input,15,FOLLOW_15_in_inscond728); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_inscond744); 
					pushFollow(FOLLOW_expression_in_inscond747);
					expression();
					state._fsp--;

					match(input,15,FOLLOW_15_in_inscond750); 
			...
			switch (alt30) {
				case 1 :
					...
					{
					match(input,25,FOLLOW_25_in_inscond769); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_ecriture866); 
		...
		try {
			...
			switch (alt35) {
				case 1 :
					...
					{
					match(input,16,FOLLOW_16_in_affouappel898); 
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			{
			match(input,9,FOLLOW_9_in_effixes955); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,13,FOLLOW_13_in_effixes962); 
			...
			match(input,10,FOLLOW_10_in_effixes972); 
			}
	...
	public final void effmods() throws RecognitionException {
		try {
			...
			{
			match(input,9,FOLLOW_9_in_effmods984); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,13,FOLLOW_13_in_effmods991); 
			...
			match(input,10,FOLLOW_10_in_effmods1001); 
			}
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,46,FOLLOW_46_in_expression1019); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,34,FOLLOW_34_in_exp11043); 
		...
		try {
			...
			switch (alt42) {
				case 1 :
					...
					{
					match(input,45,FOLLOW_45_in_exp21064); 
		...
		try {
			...
			switch (alt43) {
				...
				case 2 :
					...
					{
					match(input,20,FOLLOW_20_in_exp31107); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp41186); 
				...
				case 2 :
					...
					{
					match(input,14,FOLLOW_14_in_exp41201); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,11,FOLLOW_11_in_exp51246); 
				...
				case 2 :
					...
					{
					match(input,31,FOLLOW_31_in_exp51265); 
		...
		try {
			...
			switch (alt46) {
				...
				case 3 :
					...
					{
					match(input,9,FOLLOW_9_in_primaire1307); 
					pushFollow(FOLLOW_expression_in_primaire1309);
					expression();
					state._fsp--;

					match(input,10,FOLLOW_10_in_primaire1311); 
					}
					break;
		...
		try {
			...
			switch (alt47) {
				...
				case 2 :
					...
					{
					match(input,12,FOLLOW_12_in_valeur1333); 
				...
				case 5 :
					...
					{
					match(input,37,FOLLOW_37_in_valeur1361); 
					PtGen.pt(5);
					}
					break;
	...
	public static final BitSet FOLLOW_ptvg_in_vars382 = new BitSet(new long[]{0x0000000204000002L});
	public static final BitSet FOLLOW_decproc_in_decprocs426 = new BitSet(new long[]{0x0000800000020000L});
	public static final BitSet FOLLOW_ptvg_in_decprocs428 = new BitSet(new long[]{0x0000800000000002L});
	public static final BitSet FOLLOW_47_in_decproc444 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_decproc447 = new BitSet(new long[]{0x0020090030000000L});
	public static final BitSet FOLLOW_parfixe_in_decproc450 = new BitSet(new long[]{0x0020080030000000L});
	public static final BitSet FOLLOW_parmod_in_decproc453 = new BitSet(new long[]{0x0020000030000000L});
	public static final BitSet FOLLOW_consts_in_decproc456 = new BitSet(new long[]{0x0020000020000000L});
	public static final BitSet FOLLOW_vars_in_decproc459 = new BitSet(new long[]{0x0000000020000000L});
	public static final BitSet FOLLOW_corps_in_decproc462 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_17_in_ptvg477 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_29_in_corps495 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_corps497 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_39_in_corps499 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_40_in_parfixe511 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_parfixe513 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pf_in_parfixe515 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_17_in_parfixe519 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pf_in_parfixe521 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_10_in_parfixe525 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pf539 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf541 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_13_in_pf546 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf548 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_43_in_parmod566 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_parmod568 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pm_in_parmod570 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_17_in_parmod574 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pm_in_parmod576 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_10_in_parmod580 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pm594 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm596 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_13_in_pm601 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm603 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_instruction_in_instructions622 = new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_17_in_instructions626 = new BitSet(new long[]{0x0014040108020020L});
	...
	public static final BitSet FOLLOW_50_in_inssi692 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inssi694 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_24_in_inssi696 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inssi698 = new BitSet(new long[]{0x0008020000000000L});
	public static final BitSet FOLLOW_51_in_inssi701 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inssi704 = new BitSet(new long[]{0x0000020000000000L});
	public static final BitSet FOLLOW_41_in_inssi708 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_27_in_inscond722 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inscond725 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_inscond728 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond730 = new BitSet(new long[]{0x0000004002002000L});
	public static final BitSet FOLLOW_13_in_inscond744 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inscond747 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_inscond750 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond752 = new BitSet(new long[]{0x0000004002002000L});
	public static final BitSet FOLLOW_25_in_inscond769 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond772 = new BitSet(new long[]{0x0000004000000000L});
	...
	public static final BitSet FOLLOW_13_in_ecriture866 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_ecriture868 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_ecriture874 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel890 = new BitSet(new long[]{0x0000000000010202L});
	public static final BitSet FOLLOW_16_in_affouappel898 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_affouappel900 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_effixes_in_affouappel920 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_effmods_in_affouappel923 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_effixes955 = new BitSet(new long[]{0x0040202000005660L});
	public static final BitSet FOLLOW_expression_in_effixes958 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_13_in_effixes962 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_effixes964 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_effixes972 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_effmods984 = new BitSet(new long[]{0x0000000000000420L});
	public static final BitSet FOLLOW_ident_in_effmods987 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_13_in_effmods991 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_effmods993 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_effmods1001 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp1_in_expression1015 = new BitSet(new long[]{0x0000400000000002L});
	public static final BitSet FOLLOW_46_in_expression1019 = new BitSet(new long[]{0x0040202000005260L});
	...
	public static final BitSet FOLLOW_34_in_exp11043 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_exp2_in_exp11046 = new BitSet(new long[]{0x0000000400000002L});
	public static final BitSet FOLLOW_45_in_exp21064 = new BitSet(new long[]{0x0040202000005260L});
	...
	public static final BitSet FOLLOW_20_in_exp31107 = new BitSet(new long[]{0x0040002000005260L});
	...
	public static final BitSet FOLLOW_19_in_exp31149 = new BitSet(new long[]{0x0040002000005260L});
	...
	public static final BitSet FOLLOW_12_in_exp41186 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp5_in_exp41189 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_14_in_exp41201 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp5_in_exp41204 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_primaire_in_exp51230 = new BitSet(new long[]{0x0000000080000802L});
	public static final BitSet FOLLOW_11_in_exp51246 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_primaire_in_exp51250 = new BitSet(new long[]{0x0000000080000802L});
	public static final BitSet FOLLOW_31_in_exp51265 = new BitSet(new long[]{0x0040002000005260L});
	...
	public static final BitSet FOLLOW_9_in_primaire1307 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_primaire1309 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_primaire1311 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1325 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_12_in_valeur1333 = new BitSet(new long[]{0x0000000000000040L});
	...
	public static final BitSet FOLLOW_37_in_valeur1361 = new BitSet(new long[]{0x0000000000000002L});
