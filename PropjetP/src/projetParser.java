// $ANTLR 3.5.2 projet.g 2018-02-15 08:59:04
...
public class projetParser extends Parser {
		...
		try {
			...
			switch (alt16) {
				case 1 :
					// projet.g:73:9: 'ent'
					{
					match(input,33,FOLLOW_33_in_type403); 
					PtGen.pt(6);
					}
					break;
				case 2 :
	...
	public final void decproc() throws RecognitionException {
		try {
			...
			{
			match(input,47,FOLLOW_47_in_decproc448); 
		...
		try {
			...
			switch (alt22) {
				case 1 :
					// projet.g:83:9: ';'
					{
					match(input,17,FOLLOW_17_in_ptvg481); 
					}
					break;
				case 2 :
					// projet.g:85:3: 
	...
	public final void corps() throws RecognitionException {
		try {
			...
			{
			match(input,29,FOLLOW_29_in_corps499); 
			pushFollow(FOLLOW_instructions_in_corps501);
			instructions();
			state._fsp--;

			match(input,39,FOLLOW_39_in_corps503); 
			}
	...
	public final void parfixe() throws RecognitionException {
		try {
			...
			{
			match(input,40,FOLLOW_40_in_parfixe515); 
			match(input,9,FOLLOW_9_in_parfixe517); 
			...
			while (true) {
				...
				case 1 :
					// projet.g:90:26: ';' pf
					{
					match(input,17,FOLLOW_17_in_parfixe523); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_pf550); 
	...
	public final void parmod() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_parmod570); 
			match(input,9,FOLLOW_9_in_parmod572); 
			...
			while (true) {
				...
				case 1 :
					// projet.g:96:26: ';' pm
					{
					match(input,17,FOLLOW_17_in_parmod578); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_pm605); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,17,FOLLOW_17_in_instructions630); 
	...
	public final void inssi() throws RecognitionException {
		try {
			...
			{
			match(input,50,FOLLOW_50_in_inssi696); 
			...
			match(input,41,FOLLOW_41_in_inssi712); 
			}
	...
	public final void inscond() throws RecognitionException {
		try {
			...
			{
			match(input,27,FOLLOW_27_in_inscond726); 
			pushFollow(FOLLOW_expression_in_inscond729);
			expression();
			state._fsp--;

			match(input,15,FOLLOW_15_in_inscond732); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_inscond748); 
					pushFollow(FOLLOW_expression_in_inscond751);
					expression();
					state._fsp--;

					match(input,15,FOLLOW_15_in_inscond754); 
			...
			switch (alt31) {
				case 1 :
					...
					{
					match(input,25,FOLLOW_25_in_inscond773); 
			...
			match(input,38,FOLLOW_38_in_inscond794); 
			}
	...
	public final void boucle() throws RecognitionException {
		try {
			...
			{
			match(input,52,FOLLOW_52_in_boucle809); 
			pushFollow(FOLLOW_expression_in_boucle812);
			expression();
			state._fsp--;

			match(input,35,FOLLOW_35_in_boucle814); 
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,42,FOLLOW_42_in_lecture831); 
			match(input,9,FOLLOW_9_in_lecture833); 
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,32,FOLLOW_32_in_ecriture861); 
			match(input,9,FOLLOW_9_in_ecriture863); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_ecriture870); 
			...
			match(input,10,FOLLOW_10_in_ecriture878); 
			}
				...
				case 2 :
					...
					switch (alt35) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_effixes_in_affouappel924);
							effixes();
							state._fsp--;
							...
							switch (alt34) {
								case 1 :
									...
									{
									pushFollow(FOLLOW_effmods_in_affouappel927);
									effmods();
									state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			{
			match(input,9,FOLLOW_9_in_effixes959); 
			...
			switch (alt38) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_expression_in_effixes962);
					expression();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,13,FOLLOW_13_in_effixes966); 
	...
	public final void effmods() throws RecognitionException {
		try {
			...
			{
			match(input,9,FOLLOW_9_in_effmods988); 
			...
			switch (alt40) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_ident_in_effmods991);
					ident();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,13,FOLLOW_13_in_effmods995); 
	...
	public final void expression() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp1_in_expression1019);
			exp1();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,46,FOLLOW_46_in_expression1023); 
					pushFollow(FOLLOW_exp1_in_expression1026);
					exp1();
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,34,FOLLOW_34_in_exp11047); 
		...
		try {
			...
			switch (alt43) {
				case 1 :
					...
					{
					match(input,45,FOLLOW_45_in_exp21068); 
				...
				case 2 :
					// projet.g:153:5: exp3
					{
					pushFollow(FOLLOW_exp3_in_exp21077);
					exp3();
					state._fsp--;
	...
	public final void exp3() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp4_in_exp31093);
			exp4();
			state._fsp--;
			...
			switch (alt44) {
				case 1 :
					// projet.g:157:5: '=' exp4
					{
					match(input,21,FOLLOW_21_in_exp31100); 
				...
				case 2 :
					// projet.g:158:5: '<>' exp4
					{
					match(input,20,FOLLOW_20_in_exp31111); 
	...
	public final void exp4() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp5_in_exp41178);
			exp5();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp41190); 
		...
		try {
			...
			switch (alt47) {
				...
				case 3 :
					...
					{
					match(input,9,FOLLOW_9_in_primaire1311); 
					pushFollow(FOLLOW_expression_in_primaire1313);
					expression();
					state._fsp--;

					match(input,10,FOLLOW_10_in_primaire1315); 
					}
					break;
		...
		try {
			...
			switch (alt48) {
				...
				case 2 :
					...
					{
					match(input,12,FOLLOW_12_in_valeur1337); 
				...
				case 3 :
					...
					{
					match(input,14,FOLLOW_14_in_valeur1347); 
				...
				case 4 :
					// projet.g:186:5: 'vrai'
					{
					match(input,54,FOLLOW_54_in_valeur1357); 
					PtGen.pt(4);
					}
					break;
				case 5 :
					// projet.g:187:5: 'faux'
					{
					match(input,37,FOLLOW_37_in_valeur1365); 
					PtGen.pt(5);
					}
					break;
	...
	public static final BitSet FOLLOW_33_in_type403 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_26_in_type415 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_decproc_in_decprocs430 = new BitSet(new long[]{0x0000800000020000L});
	public static final BitSet FOLLOW_ptvg_in_decprocs432 = new BitSet(new long[]{0x0000800000000002L});
	public static final BitSet FOLLOW_47_in_decproc448 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_decproc451 = new BitSet(new long[]{0x0020090030000000L});
	public static final BitSet FOLLOW_parfixe_in_decproc454 = new BitSet(new long[]{0x0020080030000000L});
	public static final BitSet FOLLOW_parmod_in_decproc457 = new BitSet(new long[]{0x0020000030000000L});
	public static final BitSet FOLLOW_consts_in_decproc460 = new BitSet(new long[]{0x0020000020000000L});
	public static final BitSet FOLLOW_vars_in_decproc463 = new BitSet(new long[]{0x0000000020000000L});
	public static final BitSet FOLLOW_corps_in_decproc466 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_17_in_ptvg481 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_29_in_corps499 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_corps501 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_39_in_corps503 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_40_in_parfixe515 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_parfixe517 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pf_in_parfixe519 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_17_in_parfixe523 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pf_in_parfixe525 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_10_in_parfixe529 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pf543 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf545 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_13_in_pf550 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf552 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_43_in_parmod570 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_parmod572 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pm_in_parmod574 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_17_in_parmod578 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pm_in_parmod580 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_10_in_parmod584 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pm598 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm600 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_13_in_pm605 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm607 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_instruction_in_instructions626 = new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_17_in_instructions630 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instruction_in_instructions632 = new BitSet(new long[]{0x0000000000020002L});
	...
	public static final BitSet FOLLOW_50_in_inssi696 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inssi698 = new BitSet(new long[]{0x0000000001000000L});
	...
	public static final BitSet FOLLOW_51_in_inssi705 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inssi708 = new BitSet(new long[]{0x0000020000000000L});
	public static final BitSet FOLLOW_41_in_inssi712 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_27_in_inscond726 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inscond729 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_inscond732 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond734 = new BitSet(new long[]{0x0000004002002000L});
	public static final BitSet FOLLOW_13_in_inscond748 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inscond751 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_inscond754 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond756 = new BitSet(new long[]{0x0000004002002000L});
	public static final BitSet FOLLOW_25_in_inscond773 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond776 = new BitSet(new long[]{0x0000004000000000L});
	public static final BitSet FOLLOW_38_in_inscond794 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_52_in_boucle809 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_boucle812 = new BitSet(new long[]{0x0000000800000000L});
	public static final BitSet FOLLOW_35_in_boucle814 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_boucle816 = new BitSet(new long[]{0x0000001000000000L});
	public static final BitSet FOLLOW_36_in_boucle818 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_42_in_lecture831 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_lecture833 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture835 = new BitSet(new long[]{0x0000000000002400L});
	...
	public static final BitSet FOLLOW_10_in_lecture848 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_32_in_ecriture861 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_ecriture863 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_ecriture865 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_13_in_ecriture870 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_ecriture872 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_ecriture878 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel894 = new BitSet(new long[]{0x0000000000010202L});
	...
	public static final BitSet FOLLOW_effixes_in_affouappel924 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_effmods_in_affouappel927 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_effixes959 = new BitSet(new long[]{0x0040202000005660L});
	public static final BitSet FOLLOW_expression_in_effixes962 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_13_in_effixes966 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_effixes968 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_effixes976 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_effmods988 = new BitSet(new long[]{0x0000000000000420L});
	public static final BitSet FOLLOW_ident_in_effmods991 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_13_in_effmods995 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_effmods997 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_effmods1005 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp1_in_expression1019 = new BitSet(new long[]{0x0000400000000002L});
	public static final BitSet FOLLOW_46_in_expression1023 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_exp1_in_expression1026 = new BitSet(new long[]{0x0000400000000002L});
	public static final BitSet FOLLOW_exp2_in_exp11044 = new BitSet(new long[]{0x0000000400000002L});
	public static final BitSet FOLLOW_34_in_exp11047 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_exp2_in_exp11050 = new BitSet(new long[]{0x0000000400000002L});
	public static final BitSet FOLLOW_45_in_exp21068 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_exp2_in_exp21070 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp3_in_exp21077 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp4_in_exp31093 = new BitSet(new long[]{0x0000000000FC0002L});
	public static final BitSet FOLLOW_21_in_exp31100 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31104 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_exp31111 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31114 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_22_in_exp31121 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31125 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_23_in_exp31132 = new BitSet(new long[]{0x0040002000005260L});
	...
	public static final BitSet FOLLOW_19_in_exp31153 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31156 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp5_in_exp41178 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_12_in_exp41190 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp5_in_exp41193 = new BitSet(new long[]{0x0000000000005002L});
	...
	public static final BitSet FOLLOW_9_in_primaire1311 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_primaire1313 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_primaire1315 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1329 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_12_in_valeur1337 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1339 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_14_in_valeur1347 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1349 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_54_in_valeur1357 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_37_in_valeur1365 = new BitSet(new long[]{0x0000000000000002L});
